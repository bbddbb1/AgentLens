# Cross-framework conformance gates Specification

## Purpose

Defines bounded, evidence-backed conformance gates for the accepted LangGraph and Microsoft Agent Framework integrations while preserving their framework-owned native semantics and the shared projection boundary.
