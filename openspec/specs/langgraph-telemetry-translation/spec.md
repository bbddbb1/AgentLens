# langgraph-telemetry-translation Specification

## Purpose

Defines deterministic translation of LangGraph, OpenTelemetry, GenAI, and current AgentLens telemetry conventions outside generic projection construction.
