# langgraph-runtime-observability Specification

## Purpose

Defines the smallest private normalized runtime-fact and observational native-identity structure required by the LangGraph reference integration.
