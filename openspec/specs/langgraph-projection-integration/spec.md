# langgraph-projection-integration Specification

## Purpose

Defines how the current production span_projection.v1 replay/graph projector consumes private normalized LangGraph facts, preserves observational native identity, and remains the only production projection path.
