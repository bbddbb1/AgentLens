...
- [x] T010 [P] Add compatibility and downgrade tests for `runtime_explanation.v1` and `runtime_explanation.v2` behavior in `apps/api-ts/tests/unit/routes.test.ts` and `apps/web/tests/unit/explanationContract.test.ts`
