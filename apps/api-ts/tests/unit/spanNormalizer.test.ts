    ...
    const spans: OtlpSpan[] = [
      {
        ...
        attributes: {
          ...
          'agent.team': 'search-team',
          'agent.goal': 'Find AI papers',
          'agent.framework': 'langgraph',
          'agent.span.kind': 'agent.task',
          'agent.task': 'Retrieve recent LLM advancements',
        },
        events: [],
      },
    ];
    ...
    const spans: OtlpSpan[] = [
      {
        ...
        attributes: {
          ...
          'agent.tool.name': 'calculator',
          'agent.tool.input': '2 + 2',
        },
      },
    ];
